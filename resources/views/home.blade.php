...
@section('content')
        ...
        <div class="p-3 md:p-4 lg:p-5 xl:p-6 space-y-3 lg:space-y-5">
            ...
            <div class="flex flex-col justify-center space-y-2 lg:space-y-2">
                <div class="hover:scale-105 transition">
                    <x-ui.button :href="route('register')" variant="secondary-lg" aria-label="Langganan Bulanan">Bergabung
                        dengan Lokapustaka di
                        Rp20.000/bulan</x-ui.button>
                </div>
                ...
                <div class="relative hover:scale-105 transition">
                    ...
                    <x-ui.button :href="route('register')" variant="primary-lg"
                        aria-label="Langganan Tahunan">Rp75.000/tahun</x-ui.button>
                </div>
                <x-ui.button :href="route('register')" variant="text" aria-label="Lihat Katalog Lokapustaka">Lihat Katalog
                    Dulu</x-ui.button>
            </div>
    ...
    <section id="features" class="max-w-6xl mx-auto p-3 md:p-4 lg:p-5 xl:p-6 space-y-4 md:space-y-5">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-5">
            {{-- FEATURE 1 --}}
            <x-ui.feature-card title="Akses Semua Buku"
            ...
            {{-- FEATURE 2 --}}
            <x-ui.feature-card title="Harga Terjangkau"
            ...
            {{-- FEATURE 3 --}}
            <x-ui.feature-card title="Nyaman untuk Membaca"
    ...
    <section id="featured-books" class="max-w-6xl mx-auto p-3 md:p-4 lg:p-5 xl:p-6 space-y-2 md:space-y-3">
        ...
        <div class="grid grid-cols-3 md:grid-cols-6 gap-3">
            @for ($i = 1; $i <= 6; $i++)
                <x-ui.book-card :title="'Judul Buku ' . $i" :author="'Penulis ' . $i" :category="'Kategori Buku ' . $i"
