        ...
        <table class="w-full border">
            <thead
                ...
                <tr class="font-medium">
                    <th class="border border-on-surface-variant dark:border-on-surface-variant-dark py-1 px-2">Order ID</th>
            ...
            <tbody>
                @foreach ($payments as $payment)
                    <tr>
                        ...
                        <td class="border border-on-surface-variant dark:border-on-surface-variant-dark py-1 px-2">
                            {{ $payment->paid_at ? \Carbon\Carbon::parse($payment->paid_at)->translatedFormat('d F Y H:i') : '-' }}
                        </td>
                    </tr>
                @endforeach
            </tbody>
